...
urlpatterns = [
    ...
    path('sessions/<str:pk>/',
         ...
         name='session-detail'),
    path('sessions/<str:pk>/bills/',
         views.SessionViewSet.as_view({'get': 'bills'}),
         name='session-bills'),
    path('sessions/<str:pk>/statements/',
         views.SessionViewSet.as_view({'get': 'statements'}),
         name='session-statements'),
    path('sessions/<str:pk>/sentiment_by_party/',
         views.session_sentiment_by_party,
         name='session-sentiment-by-party'),
    path('bills/',
         views.BillViewSet.as_view({
             'get': 'list',
             'post': 'create'
         }),
         name='bill-list'),
    path('bills/<str:pk>/',
         ...
         name='bill-detail'),
    path('bills/<str:pk>/statements/',
         views.BillViewSet.as_view({'get': 'statements'}),
         name='bill-statements'),
    path('bills/<str:pk>/sentiment/',
         views.BillViewSet.as_view({'get': 'sentiment'}),
         name='bill-sentiment'),
    path('bills/<str:pk>/voting-sentiment/',
         views.BillViewSet.as_view({'get': 'voting_sentiment'}),
         name='bill-voting-sentiment'),
    path('speakers/',
         views.SpeakerViewSet.as_view({
             'get': 'list',
             'post': 'create'
         }),
         name='speaker-list'),
    path('speakers/<str:pk>/',
         views.SpeakerViewSet.as_view({
             'get': 'retrieve',
             'put': 'update',
             'delete': 'destroy'
         ...
         name='speaker-detail'),
    path('speakers/<str:pk>/statements/',
         views.SpeakerViewSet.as_view({'get': 'statements'}),
         name='speaker-statements'),
    path('statements/', views.statement_list, name='statement-list'),
    path('statements/create/',
         views.StatementViewSet.as_view({'post': 'create'}),
    ...
    path('sessions/<str:session_id>/sentiment-by-party/',
         views.session_sentiment_by_party,
         name='session-sentiment-by-party'),

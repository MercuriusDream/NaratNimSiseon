...
class Statement(models.Model):
    ...
    sentiment_score = models.FloatField(null=True, blank=True, help_text=_("감성 점수 (-1 ~ 1)"), verbose_name=_("감성 점수"))
    sentiment_reason = models.TextField(blank=True, help_text=_("감성 분석 근거"), verbose_name=_("감성 분석 근거"))
    ...
    bill_relevance_score = models.FloatField(null=True, blank=True, help_text=_("의안 관련성 점수 (0-1)"), verbose_name=_("의안 관련성 점수"))
    bill_specific_keywords_json = models.TextField(blank=True, help_text=_("의안 관련 키워드 JSON"), verbose_name=_("의안 관련 키워드"))
...
class VotingRecord(models.Model):
    ...
    vote_date = models.DateTimeField(null=True, blank=True, verbose_name=_("투표 일시"))
    sentiment_score = models.FloatField(default=0.0, help_text=_("투표 감성 점수 (-1 ~ 1)"), verbose_name=_("투표 감성 점수"))

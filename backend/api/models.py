...
class Speaker(models.Model):
    ...
    cmit_nm = models.CharField(max_length=100, blank=True, null=True, help_text=_("대표위원회명"), verbose_name=_("대표위원회명"))
    blng_cmit_nm = models.CharField(max_length=200, blank=True, null=True, help_text=_("소속위원회명"), verbose_name=_("소속위원회명"))
